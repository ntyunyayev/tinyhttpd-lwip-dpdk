...
$(DPDK_PKG_CONFIG_FILE): $(DPDK_SRC_DIR)
	meson setup -Ddisable_drivers=event/octeontx2,event/octeontx,regex/cn9k --prefix=$(DPDK_INSTALL_DIR) --libdir=lib/x86_64-linux-gnu $(DPDK_SRC_DIR)/build $(DPDK_SRC_DIR)
